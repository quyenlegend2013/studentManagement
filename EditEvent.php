<?php
	...
	$retvalEditEvent=mysqli_query($conn,$sql);
	$queryEditEvent=mysqli_fetch_array($retvalEditEvent);
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
			...
			<div class="row mt-2 ml-1">
            	<p><a href="event.php">Event</a> / Edit Event</p>
            </div>
           
            
            <form action="xulyEditEvent.php" method="post">
            <div class="row" style="margin-left:10%">
            	<div class="col-5 card card-body">
                	<div class="row mt-1">
						<h6 class="card-title">Basic Information</h6>
					</div>
                    <input type="hidden" name="eventID" value="<?php echo $queryEditEvent["eventID"] ?>" />
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Event name" value="<?php echo $queryEditEvent["eventName"] ?>" name="eventName" />
                    </div>
                ...
                <div class="col-5 card card-body" style="margin-left:2%">
                    ...
                    <div class="row mt-3">
                    	<input type="date" class="form-control" value="<?php echo $queryEditEvent["date_start"] ?>" placeholder="Date Start" name="date_start" />
                    </div>
                    <div class="row mt-3">
                    	<input  type="date" class="form-control" value="<?php echo $queryEditEvent["date_end"] ?>" placeholder="Date end" name="date_end" />
                    </div>
                   
                    <div class="row mt-3">
                    	<input type="text" class="form-control" value="<?php echo $queryEditEvent["time"] ?>" placeholder="Time" name="time" />
                    </div>
                    <div class="row mt-4">
						<h6 class="card-title">Feedback</h6>
					</div>
                    <div class="row mt-3">
                    	<input type="text" class="form-control" value="<?php echo $queryEditEvent["feedback"] ?>" placeholder="feedback" name="feedback" />
                    </div>
                </div>
            </div>
            <div class="row mt-2">
